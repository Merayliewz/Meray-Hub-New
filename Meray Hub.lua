...
getgenv().Image = "rbxassetid://131799663473399"; -- put a asset id in here to make it work
getgenv().ToggleUI = "LeftShift" -- This where you can Toggle the Fluent ui library
...
task.spawn(function()
    if not getgenv().LoadedMobileUI == true then getgenv().LoadedMobileUI = true
        ...
        ImageButton.Position = UDim2.new(0.08,0,0.175,0);
...
local Window = Fluent:CreateWindow({
    Title = "Meray Hub | Free Script",
    SubTitle = "by hoangnguyen",
    TabWidth = 160,
...
local Tabs = {
    ...
    Auto Item = Window:AddTab({ Title = "Auto Item", Icon = "" }),
    Players = Window:AddTab({ Title = "Players", Icon = "" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "" }),
    Raid - Fruit = Window:AddTab({ Title = "Raid - Fruit", Icon = "" }),
